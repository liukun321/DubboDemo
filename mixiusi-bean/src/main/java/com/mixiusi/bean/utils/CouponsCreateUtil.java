...
public class CouponsCreateUtil {
	     ...
	     * 生成红包最小值 4元
	     */
	    private static final int MIN_MONEY = 4 * 100;
...
//	        //如果生成的金额不合法 则递归重新生成
	    ...
	    public void typeOfCoupons1(int count, List<Double> range) {
	    ...
	    public static void main(String[] args) {
	        ...
	        List<Integer> redPackets = redPacket.typeOfCoupons2(10000, 20);
